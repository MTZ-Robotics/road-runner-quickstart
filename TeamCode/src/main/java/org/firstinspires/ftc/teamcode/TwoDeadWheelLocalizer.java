...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1526.5817091712026; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2619.135020705655; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick) {
        ...
        //par is on port 3 backRight
        //perp is on port 0 frontLeft
